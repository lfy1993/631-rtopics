...
mean(population)
```
Yes, Because it is in the range of 1307.728 and 1509.672. 
...
To decrese the population mean which are not contained, we can simply increase the critical value into our calculation. 

# Submission



Discussion Link: https://stthomas.instructure.com/courses/30116/discussion_topics/243126
hw5 <Response> <I bascially talked about my understanding of set.seed() function>

Discussion Link: https://stthomas.instructure.com/courses/30116/discussion_topics/242953
hw5 <response> <I answered the problems on question 8> 